          ...
          <div className="space-y-4 flex-1">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              {[
                ...
                { icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', text: 'info@medconsultant.in' },
              ].map(({ icon, text }) => (
                <div key={text} className="flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2">
                  <svg className="w-3.5 h-3.5 text-[#48cae4]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="space-y-3 pt-2">
            {[
              ...
              },
              {
                ...
                label: 'Email',
                value: 'info@medconsultant.in',
              },
              {
                icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z',
                label: 'Address',
                value: 'A 66, Second Floor, Rajouri Garden Opposite Rajouri Garden Metro, Gate No 5, New Delhi – 110027',
              },
              {
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <InputField placeholder="NEET Score" type="number" />
              </div>
              <div className="grid grid-cols-2 gap-3">
              ...
              <button
                type="submit"
                className="w-full bg-white hover:bg-[#eff8ff] text-[#0a3d62] font-bold py-3.5 rounded-xl text-sm tracking-wide shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2 group"
              >
                Submit Enquiry
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[#48cae4] font-black text-xl tracking-wide">+91 98765 43210</p>
            </div>
          </div>
          <Link
            href="/contact"
            ...
            <div className="grid md:grid-cols-5">
              ...
              <div className="md:col-span-2 bg-gradient-to-br from-[#0a3d62] to-[#071e2e] p-10 flex flex-col justify-between gap-10">
                <div className="space-y-6">
                  ...
                  <div className="space-y-5">
                    {[
                      { icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', label: 'Email', value: 'mail@medconsultant.in' },
                      { icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z', label: 'Phone', value: '+91 98765 43210' },
                      { icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z', label: 'Address', value: 'A 66, Second Floor, Rajouri Garden Opposite Rajouri Garden Metro, Gate No 5, New Delhi, Delhi 110027' },
                    ].map(({ icon, label, value }) => (
              ...
              <div className="md:col-span-3 p-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="relative">
                      <select defaultValue="" className="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1a6fa8]/30 focus:border-[#1a6fa8] transition-all appearance-none cursor-pointer">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-[#0a3d62] to-[#1a6fa8] hover:from-[#0c4a77] hover:to-[#1e7fc0] text-white font-bold py-4 rounded-xl text-sm tracking-wide shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2 group"
                  >
                    Submit Query
                    <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-6">
          ...
          <div className="w-full h-80 rounded-3xl overflow-hidden border border-slate-100 shadow-md">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.2!2d77.1!3d28.6!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjjCsDM2JzAwLjAiTiA3N8KwMDYnMDAuMCJF!5e0!3m2!1sen!2sin!4v1"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
